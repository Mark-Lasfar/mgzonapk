// /home/mark/Music/my-nextjs-project-clean/lib/types/marketplace.ts
export interface MarketplaceProduct {
  // availability: any;
  availability: 'in_stock' | 'out_of_stock'; // Updated from any to specific enum
...
export interface ExportResult {
  ...
  url?: string;
  data?: any;
  exportedId?: string; // Added to fix error
  errors?: string[];
  stats: {
    total: number;
    exported: number;
