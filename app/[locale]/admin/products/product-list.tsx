...
const ProductList = () => {
  ...
  async function handleStatusChange(productId: string, status: 'active' | 'rejected') {
    try {
      ...
      if (data.success) {
        ...
        // إعادة جلب المنتجات لتحديث الصفحة
        const refreshedData = await getAllProductsForAdmin({ query: inputValue, page })
                ...
                <TableRow key={product._id}>
                  ...
                  <TableCell>
                    ...
                    {product.status === 'pending' && (
                      <>
                        <Button onClick={() => handleStatusChange(product._id, 'active')}>Approve</Button>
