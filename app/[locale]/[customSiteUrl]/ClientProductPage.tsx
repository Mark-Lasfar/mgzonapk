...
interface ClientProductPageProps {
  seller: any; // استبدل بـ interface المناسب إذا كان عندك نوع للبائع
  product: any; // استبدل بـ interface المناسب إذا كان عندك نوع للمنتج
  relatedProducts: any[]; // استبدل بـ interface المناسب
  locale: string;
