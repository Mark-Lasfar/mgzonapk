                ...
                <Tabs defaultValue="businessInfo" className="w-full">
                  ...
                  <TabsContent value="security">
                    <Card>
                      ...
                      <CardContent>
                        <SecuritySettings userId={seller.userId} form={form} locale={locale} />
                      </CardContent>
                    </Card>
                  </TabsContent>
                  {/* Template Tab */}
                  ...
                  {/* Template Editor Tab */}
                  <TabsContent value="templateeditor">
                    <Card>
                      <CardHeader>
                  ...
                  <TabsContent value="integrationsmanager">
                    <Card>
                      <CardHeader>
                  ...
                  <TabsContent value="deliveryDates">
                    <Card>
                      <CardHeader>
